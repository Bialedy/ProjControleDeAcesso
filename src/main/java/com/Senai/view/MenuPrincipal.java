...
public class MenuPrincipal {
    ...
    public static void logar(){
        Optional<Usuario> usuarioLogado = new LoginView().exibirLogin(); //chamada de classes
        usuarioLogado.ifPresent(MenuPrincipal::redirecionarMenu); //salva no banco de dados
    }
